        ...
        private void BT_Update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string DBUpdate = "update USERS set Name='" + this.TB_Name.Text + "',SurName='" + this.TB_Surname.Text + "',Password='" + Md5(this.TB_Password.Text) + "',Email ='" + this.TB_E_Posta.Text + "',Phone ='" + this.TB_TelephoneNumber.Text + "',BirthDay ='" + this.dateTimePicker1.Value.ToString("yyyy-MM-dd") + "',USID ='" + Convert.ToInt32(this.TB_USID.Text) + "' where UID ='" + Convert.ToInt32(this.TB_UID.Text) + "'; ";
                    SqlConnection connect = new SqlConnection(connectionString);
